    ...
    <div className="space-y-4 font-sans">
      ...
      {contenu.objectif && (
        <p className="text-sm text-gray-200 bg-blue-500/10 border border-blue-600/30 rounded-lg px-3 py-2">
          <span className="font-semibold text-blue-300">🎯 Objectif : </span>{contenu.objectif}
        </p>
      )}
      ...
      return (
        <div className="rounded-xl border border-gray-800 bg-gray-900/30 p-4 flex gap-3">
          ...
          <div className="min-w-0">
            {bloc.titre && <p className="text-sm font-semibold text-gray-100">{bloc.titre}</p>}
            <p className="text-sm text-gray-300 leading-relaxed whitespace-pre-line mt-0.5">{bloc.texte}</p>
          </div>
        </div>
      )
